...
El presente proyecto implementa rutinas SQL (funciones y procedimientos almacenados) para la generación dinámica de pacientes dentro de un modelo de base de datos hospitalario, respetando la estructura jerárquica relacional:
